...
public unsafe class OverrideMovement : IDisposable
{
    ...
    private void RMIWalkDetour(void* self, float* sumLeft, float* sumForward, float* sumTurnLeft, byte* haveBackwardOrStrafe, byte* a6, byte bAdditiveUnk)
    {
        ...
        bool movementAllowed = bAdditiveUnk == 0 && _rmiWalkIsInputEnabled1(self) && _rmiWalkIsInputEnabled2(self); //&& !Svc.Condition[Dalamud.Game.ClientState.Conditions.ConditionFlag.BeingMoved];
