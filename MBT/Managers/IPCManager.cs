...
namespace AutoDuty.Managers
{
    internal static class IPCManager
    {
        ...
        internal static float VNavmesh_TaskProgress => VNavmesh_IsEnabled ? Svc.PluginInterface.GetIpcSubscriber<float>("vnavmesh.TaskProgress").InvokeFunc() : -1;
        internal static int VNavmesh_WaypointsCount => VNavmesh_IsEnabled ? Svc.PluginInterface.GetIpcSubscriber<int>("vnavmesh.WaypointsCount").InvokeFunc() : -1;
